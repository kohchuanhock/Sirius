 ...
 */
public class MyAttributeSelectionPanel
  extends JPanel {
  ...
  class AttributeTableModel
     ...
     */
    public AttributeTableModel(JFrame parent,Instances instances) {
    	this.parent = parent;
    ...
    public int [] getSelectedAttributes() {
      ...
      if(m_Selected[getRowCount()-1]){
      	JOptionPane.showMessageDialog(parent,"Class attribute should not be selected to remove","Error",
      		JOptionPane.ERROR_MESSAGE);
      	m_Selected[getRowCount()-1] = false;
      	fireTableRowsUpdated(m_Selected.length - 1, m_Selected.length);
      	return new int[0];
      }      	
  ...
  protected JButton m_IncludeAll = new JButton("Mark All");

  /** Press to deselect all attributes */
  protected JButton m_RemoveAll = new JButton("Unmark All");
   ...
   */
  public MyAttributeSelectionPanel() {
   ...
   */
  public void setInstances(JFrame parent,Instances newInstances) {
	if(newInstances == null)
		return;//do nothing
    if (m_Model == null) {
      m_Model = new AttributeTableModel(parent,newInstances);
  ...
  /*public static void main(String[] args) {
	...
	throw new Exception("supply the name of an arff file");
      ...
      MyAttributeSelectionPanel asp = new MyAttributeSelectionPanel();
