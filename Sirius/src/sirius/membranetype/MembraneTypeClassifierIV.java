...
public class MembraneTypeClassifierIV {
	/*
	 * This class is single layer and uses oneVsAll approach and picks the most likely one as classifier
	 */
	public static void main(String[] args){
		try{
			...
			System.out.println();
			if(args.length != 5){
				System.err.println("1) MaxFoldDiff - -1 => No resample, 0 => resample till same, 1 => resample evenly");
	...
	public static void mainMethod(int maxFoldDiff, int numOfClassifiers, int runGPI, int classifierCode, int predictOnlyOne) throws Exception{
		 ...
		 */
		String[] featureString = new String[9];
		featureString[0] = "NonMembraneVsAll";
		featureString[1] = "TypeIVsAll";
		featureString[2] = "TypeIIVsAll";
		featureString[3] = "TypeIIIVsAll";
		featureString[4] = "TypeIVVsAll";
		featureString[5] = "MultiPassVsAll";
		featureString[6] = "LipidAnchorVsAll";
		featureString[7] = "GPIAnchorVsAll";
		featureString[8] = "PeripheralVsAll";		
		/*
		 * Sequences for Detail Splitting
		 */
		String[] sequenceString = new String[10];
		sequenceString[0] = "All";		
		sequenceString[1] = "MultiPass";
		sequenceString[2] = "TypeI";
		sequenceString[3] = "TypeII";
		sequenceString[4] = "TypeIII";
		sequenceString[5] = "TypeIV";
		sequenceString[6] = "LipidAnchor";
		sequenceString[7] = "GPIAnchor";
		sequenceString[8] = "Peripheral";
		sequenceString[9] = "NonMembrane";
		
		String gaDir = Utils.selectDirectory("Select the GA dir", "GA: ");
		System.out.println("Successfully selected GA Dir");
	...
	public static void trainClassifiers(String[] featureString,
		...
		for(String fs:featureString){
			 ...
			 * Remove from neg
			 * Note: this happens because it is troublesome to extract individually for each membrane type from
			...
			for(int a = 0; a < numOfClassifiers; a++){
				...
				case 1://RF
					...
					FastRandomForest rf = new FastRandomForest();//default is 10 trees
					rf.setNumTrees(100);//Set to 100
					c = rf;
					break;
				case 2://SMO
	...
	public static void predictMemtypeSequences(String[] memtypeString, String[] featureString, 
		...
		for(int a = 0; a < memtypeString.length; a++){
			...
			List<MembraneTypePrediction> votingPredictionList = SiriusClassifier.predictMembraneTypeIV(
			...
			List<MembraneTypePrediction> aggregatePredictionList = SiriusClassifier.predictMembraneTypeIV(
	...
	public static void predictGPISequences(List<FastaFormat> gpiList, List<FastaFormat> nonGPIList, String outputDir, Hashtable<String, 
		...
		List<MembraneTypePrediction> votingGPIPredictionList = SiriusClassifier.predictMembraneTypeIV(
		...
		List<MembraneTypePrediction> votingNonGPIPredictionList = SiriusClassifier.predictMembraneTypeIV(
		...
		List<MembraneTypePrediction> aggregateGPIPredictionList = SiriusClassifier.predictMembraneTypeIV(
		...
		List<MembraneTypePrediction> aggregateNonGPIPredictionList = SiriusClassifier.predictMembraneTypeIV(
